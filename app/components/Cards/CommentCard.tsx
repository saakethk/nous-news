...
// IMPORTS
import { Card, CardHeader, Avatar, CardFooter, CardBody, ButtonGroup } from "@nextui-org/react";
import { Comment, User } from "@/firebase/database_types";
import { getUser, getUsername, getNumDays } from "@/firebase/helper";
import { MessageCircle, ThumbsUp } from "lucide-react";
import { LikeCommentButton, ReplyButton, ViewRepliesButton } from "../Buttons/Comment/CommentButtons";
...
export default async function CommentCard(
    ...
    // Gets associated user of comment
    const associated_user = await getUser(comment.user_association);
        ...
        <Card className="comment_card">
            <CardHeader className="justify-between">
                ...
                <ButtonGroup className="comment_reply_buttons">
                    ...
                    <ViewRepliesButton comment={JSON.parse(JSON.stringify(comment))} />
                </ButtonGroup>
            </CardHeader>
